...
st.write("Upload your CSV file to analyze customer purchase behavior and sales trends.")
...
if uploaded_file is not None:
    try:
        ...
        # Check for critical missing values before dropping
        ...
        critical_missing_after = df[['Age', 'Gender', 'Loyalty Member', 'Payment Method']].isnull().sum().sum()
        ...
        st.info("Please ensure your CSV file has the expected columns for analysis.")
else:
    st.info("Please upload a CSV file to begin analysis. (Example: 'Electronic_sales_Sep2023-Sep2024.csv')")
